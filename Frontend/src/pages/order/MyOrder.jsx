...
import { cancelService, getMyRequest } from "../../services/ServiceService";
...
const MyOrder = () => {
  ...
  const fetchOrders = async () => {
    ...
    try {
      ...
      const ordersData = response?.orders?.orders || [];
  ...
  const handleDelete = async (id) => {
    setLoadingOrders((prev) => ({ ...prev, [id]: true })); // Set loading for specific order
    try {
      const response = await deleteMyOrder(id);
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-4 pb-12">
        <div className="flex flex-col lg:flex-row gap-8">
          <div className="flex-grow">
            <div className="mb-4 space-y-6 bg-white p-6 rounded-md">
                  ...
                  <table className="w-full table-auto">
                    <thead className="bg-slate-600 text-white ">
                      <tr>
                        ...
                        <th className="px-0 text-left text-xs font-semibold  uppercase tracking-wider">
                          Applied Date
                        </th>
                        <th className="px-6 py-4 text-left text-xs font-semibold  uppercase tracking-wider">
                          Status
