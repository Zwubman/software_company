...
const AgentSkeleton = () => (
  <div className="group bg-white/40 backdrop-blur-xl border border-orange-200/40 p-10 rounded-[2rem] shadow-2xl transition-transform duration-300 hover:scale-[1.03] ">
    ...
    <h3 className="text-2xl font-bold text-orange-700 mb-2 bg-gray-300 h-6 animate-pulse"></h3>
    <p className="text-base text-gray-700 font-medium mb-1 bg-gray-300 h-4 animate-pulse"></p>
    <p className="text-sm text-gray-600 bg-gray-300 h-4 animate-pulse"></p>
  </div>
);
            ...
            {agents.map((agent, i) => (
              <div className="group bg-white/40 backdrop-blur-xl border border-orange-200/40 p-10 rounded-[2rem] shadow-2xl transition-transform duration-300 hover:scale-[1.03] ">
                ...
                <p className="text-base text-slate-700 font-bold mb-1">
                  {agent.agentType === "Woreda"
                    ? agent.Woreda.name + " woreda agent"
                    : agent.agentType === "Zone"
                    ? agent.Zone.name + " zone agent"
                    : agent.Region.name + " region agent"}
                </p>
                <p className="text-base text-gray-700 font-light mb-1">
