          ...
          <div className="">
            ...
            <div className="overflow-x-auto ">
              <table className="min-w-full  rounded-lg  overflow-x-scroll">
                <thead className="bg-slate-700 text-white min-w-full">
                  <tr>
                    <th className=" px-6 py-3 text-left text-sm font-semibold ">
                      Title
                    </th>
                    <th className=" px-6 py-3 text-left text-sm font-semibold  hidden xl:table-cell">
                      Description
                    </th>
                ...
                <tbody className="bg-white overflow-x-scroll min-w-full ">
                  {loading ? (
                    ...
                    reports?.map((report) => (
                      ...
                      >
                        ...
                        <td className=" px-6 py-4  text-sm font-medium text-gray-800 hidden xl:table-cell ">
